...
global.swa = 'wa.me/6282117289550'
global.swb = 'https://'
...
/*============== WATERMARK ==============*/
global.wm = 'GBotz | By Yatz' //Main Watermark
global.wm2 = 'GBOT'
global.wm3 = 'GBOTV5 | By Yatz'
global.botdate = `⻝ Tanggal: ${week} ${date}\n⻝ Waktu: ${wktuwib}`
global.bottime = `⻝ W A K T U : ${wktuwib}`
global.titlebot = `GBOT | ʙʏ ${global.nameown}`
global.author = 'YatzModz' 
global.packname = 'By GBOT'
global.danied = '✘ 𝗘𝗥𝗢𝗥 𝟰𝟬𝟰'
global.ultahowner = 'April 26 2007' //Ganti Ultah Lu Disini
